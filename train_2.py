from trainer import LightningProsodyAttentionModel, get_checkpoint_earlystop
...
if __name__ == "__main__":
    ...
    model = LightningProsodyAttentionModel(n_class=n_class)
    run_name = f"{data_name}-2-prosody_concat_noselfattn=test"
