from trainer import LightningBaselineModel, get_checkpoint_earlystop

from s2idatasets.slurp import get_mel_dataloaders as slurp_loaders
from s2idatasets.stop import get_mel_dataloaders as stop_loaders
...
if __name__ == "__main__":
    ...
    model = LightningBaselineModel(n_class=n_class)
    run_name = f"{data_name}-1-baseline=3"
