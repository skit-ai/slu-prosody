from trainer import LightningProsodyConcatModel, get_checkpoint_earlystop
...
if __name__ == "__main__":
    ...
    model = LightningProsodyConcatModel(n_class=n_class)
    run_name = f"{data_name}-1-prosody_concat=prefinal"
